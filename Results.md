...
![Главная страница](docs/screenshots/Начальное окно.png)
...
![Линейный график и таблица операций](docs/screenshots/Динамика и операции.png)
...
![Форма добавления операции](docs/screenshots/Добавление операции.png)
...
![Редактирование категории](docs/screenshots/редактировать категорию.png)
...
![Пример сгенерированного PDF-отчёта](docs/screenshots/пример отчета.png)
